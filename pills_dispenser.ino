...
const char* serverName = "https://medibot.pythonanywhere.com/get-medicine/";
...
// Imp
// To connect to a wifi connect button pin to gnd and restart esp8266
// esp8266 will switch to AP mode
// From any device connect to wifi named Scobo and open wifi captive portal
// Enter wifi ssid, password and click on save
// Disconnect the button pin from ground and restart the esp8266
// Your esp8266 will automatically connect to the wifi
...
// Check if the button is pressed during startup
  ...
  Serial.println("Web server started\n");
    ...
    Serial.println("\nConnected to https://medibot.pythonanywhere.com !\n");
